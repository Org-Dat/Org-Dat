...
$(document).ready(function() {
    ...
    var selectColumn = 0;
    // 	-------------------------------Share page-------------------------------------
    $(document).on("click", ".main_tab th", function() {
        if (selectColumn % 2 == 0) {
            $(".del_col").css(  "visibility", "visible");
            var num = $(this).index() + 1;
            // alert($(this).index());
            $(".mn_tb td:nth-child(" + num + ")").css({
    ...
    $(document).on("click", ".fa-share-alt", function() {
        ...
        $(".share-proper").attr("name", $(this).parent().siblings("span").text());
    ...
    */
    ...
    // $(document).on("click", ".main_tab th", function() {
    //     $(".del_row:first-child").css(  "visibility", "visible")
    // });
    $(document).on("click", ".main_tab th:nth-child(1) > input[type='checkbox']", function() {
        ...
        $(".del_col").css("visibility","hidden");
        $(".mn_tb td:nth-child(1) > input[type='checkbox']").attr("checked","true"); 
    })
    ...
    $(document).on("click", ".fa-sort", function() {
        $(this).siblings(".sort_box").slideToggle();
    })
    $(document).on("click", ".fa-search", function() {
        ...
        $('.filter_search').html(theCompiledHtml);
    ...
    $(".hdr>button:nth-child(1)").click(function() {
        ...
        setTimeout(function() {
            ...
            $(".whole_popup>div,.whole_popup button").css("opacity", "1")
        }, 500)
    });
    ...
    $(".submit,.cancel").click(function() {
        ...
        setTimeout(function() {
            $(".whole_popup").css("transform", "translateY(-300px) scale(0.2)")
        }, 500)
    })
