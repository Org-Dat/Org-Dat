...
public class BackUpRestore{
    ...
    public static String CSVFile(String user , String datName ,String tabName, String path, String option,String header)  {
        /** 
         ...
         * 
         */
        String query  = "copy "+tabName+" " + option + " '"+path+"' csv ";
	...
	public static String SQLFile(String user , String db_name , String path, String option ){
	    try {
            try  {
                /** 
                 ...
                 * 
                 */
                String command = "pg_dump -U "+user+" -d "+db_name+" "+option + " -f "+path+" ";
